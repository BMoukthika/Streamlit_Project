...
if f1 is not None:
    ...
    os.chdir(r"/Users/mburug/Documents/Streamlit_project")
...
with cl2:
    with st.expander("Regional_ViewData"):
...
region_color_map = {region: "Reds" for region in filtered_df["Region"].unique()}
